...
- **TR-002**: [Integration requirement]
- **TR-003**: Platform UI pattern MUST be followed (Responsive Web / Material Design / HIG)

### Security Requirements (OWASP — mandatory)

- **SR-001**: All inputs MUST be validated with Zod schemas before processing.
- **SR-002**: All route handlers MUST be protected by `withAuth` middleware.
- **SR-003**: Supabase RLS policies MUST be defined for tables accessed by this feature.
- **SR-004**: No PII or secrets MUST appear in logs or error responses.
- **SR-005**: [Any feature-specific security constraint]
