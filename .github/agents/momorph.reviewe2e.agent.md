---
description: Review Playwright E2E test changes for POM compliance, robust selector strategy, test data separation, performance, and adherence to .momorph/guidelines/e2e/3_code_review_standards.md.
